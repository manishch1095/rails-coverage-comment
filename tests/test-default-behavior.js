...
const mockOctokit = {
  issues: {
    ...
    createComment: async (params) => {
      console.log('=== COMMENT BODY (DEFAULT BEHAVIOR) ===');
...
// Test the action with default behavior (include-file-details = false)
async function testDefaultBehavior() {
  console.log('Testing default behavior (include-file-details = false)...');

  // Set up inputs as environment variables - NOT setting include-file-details
  process.env.INPUT_GITHUB_TOKEN = 'test-token';
  process.env.INPUT_COVERAGE_FILE =
    '/Users/manishchauhan/projects/title_chaining/coverage/coverage.json';
  process.env.INPUT_INCLUDE_FILE_DETAILS = 'false'; // Explicitly set to false
